...
translation_dict = {
    "ja_JP": {
        ...
        ("Operator", "Import Shape Keys from CSV"): "CSVファイルのリストからシェイプキーを追加",
        ...
        ("*", "Json (key name list)"): "Json (キーの名前一覧)",
        ("*", "Json (pair template)"): "Json (ペア用雛形)",
        ("*", "Json (old/new list)"): "Json (旧・新リスト)",
        ...
        ("Operator", "Select All"): "すべて選択",
        ("Operator", "Select all shape keys"): "シェイプキーをすべて選択します",
        ("Operator", "Deselect All"): "すべて解除",
        ...
        # sort
        ("*", "Sort active group only"): "アクティブグループのみソート",
        ("*", "Sort groups"): "グループをソート",
        ("Operator", "Sort by ShapeKey Name"): "シェイプキー名でソート",

        # tag clear descriptions
        ("*", "Clear tags on all shape keys"): "すべてのシェイプキーのタグをクリア",
        ("*", "Clear tags on active shape key"): "アクティブシェイプキーのタグをクリア",

        # reports
        ("*", "Library cannot be edited"): "ライブラリは編集できません",
        ("*", "No tags available"): "タグがありません",
        ("*", "Tag not found"): "タグが見つかりません",
        ("*", "Subtract shape key not found"): "減算シェイプキーが見つかりません",
        ("*", "Vertex group not found"): "頂点グループが見つかりません",
        ("*", "Cleaned {} vertices"): "{}個の頂点をクリーンしました",
        ("*", "Skip: '{}' in '{}' (conflict)"): "スキップ: '{}'（'{}'で名前が競合）",

        # operators (labels / descriptions)
        ("Operator", "Add Shape Key"): "シェイプキーを追加",
        ("Operator", "Apply Modifier"): "モディファイアを適用",
        ("*", "Mute all shape keys"): "すべてのシェイプキーをミュート",
        ("*", "Keyframe all shape keys"): "すべてのシェイプキーにキーフレーム",
        ("Operator", "Show All"): "すべて表示",
        ("Operator", "Change Active Shape Key"): "アクティブなシェイプキーを変更",
        ("*", "Select Shape Key"): "シェイプキーを選択",
        ("*", "Conv"): "変換",
        ("Operator", "Add Tag"): "タグを追加",
        ("Operator", "Rename"): "名前を変更",
        ("Operator", "Rename Tag"): "タグの名前を変更",
        ("Operator", "Assign Tag"): "タグを割り当て",
        ("Operator", "Switch Tags"): "タグを切り替え",
        ("Operator", "Auto define tags"): "タグを自動定義",
        ("Operator", "Create Rule"): "ルールを作成",
        ("Operator", "Add Source"): "ソースを追加",
        ("Operator", "Remove Source"): "ソースを削除",
        ("Operator", "Clean Vertex"): "頂点をクリーン",
        ("Operator", "Paste Shape Key"): "シェイプキーをペースト",
        ("Operator", "Paste shape to the active object"): "アクティブオブジェクトにシェイプをペースト",
        ("Operator", "Toggle Shape Key"): "シェイプキーを切り替え",
        ("*", "Toggle Shape Key Value"): "シェイプキーの値を切り替え",
        ("Operator", "Set Shape Key Properties"): "シェイプキーのプロパティを設定",
        ("Operator", "Apply Mask"): "マスクを適用",
        ("Operator", "Switch Groups"): "グループを切り替え",
        ("Operator", "Remove shape key from the object"): "オブジェクトからシェイプキーを削除",
        ("Operator", "Swap active shape key with basis shape"): "アクティブなシェイプキーとBasisを入れ替え",
        ("Operator", "Transfer Shape Key Properties"): "シェイプキーのプロパティを転送",
        ("Operator", "Move Shape Key"): "シェイプキーを移動",
        (
            "Operator",
            "Move Shape Key\n[Shift] 10 Move\n[Shift][Ctrl] 100 Move",
        ): "シェイプキーを移動\n[Shift] 10移動\n[Shift][Ctrl] 100移動",
        ("Operator", "Add Item"): "項目を追加",
        ("Operator", "Remove Item"): "項目を削除",
        ("Operator", "Move Preset"): "プリセットを移動",

        # ui panels / menus
        ("*", "Mio3 Shape Keys"): "Mio3 シェイプキー",
        ("*", "Mio3 Shape Keys Menu"): "Mio3 シェイプキーメニュー",
        ("*", "Add"): "追加",
        ("*", "Move"): "移動",
        ("*", "Settings"): "設定",
        ("*", "Blend"): "ブレンド",
        ...
        ("*", "Text"): "テキスト",
        ("*", "CSV"): "CSV",
        ("*", "Shrink Shape Keys"): "Shrink シェイプキー",

        # tag / preset enums
        ("*", "Label"): "ラベル",
        ("*", "Assign Selected Keys"): "選択したキーに割り当て",
        ("*", "Assign All"): "すべて割り当て",
        ("*", "Remove All"): "すべて削除",
        ("*", "Color"): "カラー",
        ("*", "Up"): "上",
        ...
        ("*", "Filter"): "フィルター",
        ("*", "Jump"): "ジャンプ",
        ("*", "Sidebar Size Factor"): "サイドバーサイズ係数",
        ('*', 'e.g., "Eye_L" with "Eye_R"'): '例: "Eye_L" と "Eye_R"',
        ("*", "Sidebar"): "サイドバー",
        ...
        ("*", "Show Lock"): "ロックを表示",
        ("*", "Show Mute"): "ミュートを表示",
        ("*", "Show Keyframe"): "キーフレームを表示",
        ("*", "Custom Group Prefix"): "カスタムグループプレフィックス",
        ("*", "Prefix"): "プレフィックス",
        ("*", "None"): "なし",
        ("*", "Auto"): "自動",
        ("*", "Custom"): "カスタム",
        ("*", "No prefix will be used"): "プレフィックスは使用しません",
        ("*", "Group by '---' or '==='"): "'---' または '===' でグループ化",
        ("*", "Use a custom prefix for grouping shape keys"): "カスタムプレフィックスでシェイプキーをグループ化",
        ("*", "Group Name"): "グループ名",
        ("*", "Group Hide"): "グループを非表示",
        ("*", "Group Hidden"): "グループ非表示",
        ("*", "Group Active"): "グループアクティブ",
        ("*", "Group Count"): "グループ数",
        ("*", "Preset Name"): "プリセット名",
        ("*", "Hide"): "非表示",
        ("*", "Tag Filter Type"): "タグフィルタータイプ",
        ("*", "Tag Invert"): "タグ反転",
        ("*", "Tag Edit"): "タグ編集",
        ("*", "Preset Edit"): "プリセット編集",
        ("*", "Blend Source"): "ブレンドソース",
        ("*", "Copy Source"): "コピーソース",
        ("*", "Range Min"): "範囲最小",
        ("*", "Range Max"): "範囲最大",
        ("*", "New Key"): "新しいキー",
        ("*", "Number of shape keys to move"): "移動するシェイプキーの数",
        ("*", "Method"): "方法",
        ("*", "Order"): "順序",
        ("*", "Rename Search"): "検索文字列",
        ("*", "Rename Replace"): "置換文字列",
        ("*", "Mio3 Shape Keys Extend Data"): "Mio3 シェイプキー拡張データ",
    }
}  # fmt: skip
